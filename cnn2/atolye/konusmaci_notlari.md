...
| Bölüm | Süre |
|---|---|
| 0. Kurulum + tekrar + YOLO nedir | 20 dk |
| 1. Kırılma anı | 15 dk |
| 2. İlk tespit | 15 dk |
...
**Yap:** "Bugün kullanacağımız model: YOLO" bölümünü aç.

**Söyle:**
"Kullanacağımız modelin adı YOLO. Açılımı *You Only Look Once* — sadece bir kez bak.
İsim, fikrin kendisi."

"2015'ten önce tespit şöyle yapılıyordu: görüntüden binlerce aday bölge çıkar, her
birini ayrı ayrı sinir ağından geçir. Doğru sonuç veriyordu ama **tek fotoğraf
dakikalar sürüyordu**."

"YOLO dedi ki: neden defalarca bakıyoruz? Görüntüyü **bir kere** ağdan geçirelim,
bütün kutuları ve sınıfları aynı anda tahmin edelim. Ağ görüntüyü bir ızgaraya böler,
her hücre 'benim bölgemde nesne var mı, varsa nerede ve ne' sorusunu aynı geçişte
cevaplar."

"Sonuç: dakikalar yerine **milisaniyeler**. Gerçek zamanlı tespit böyle mümkün oldu."

**Söyle — veri seti:**
"Peki bu model neyle eğitildi? **COCO** diye bir veri setiyle. Common Objects in
Context. 330 bin görüntü, 1.5 milyondan fazla etiketlenmiş nesne, **80 sınıf**."

**Vurgula — dünle farkı:**
"Dün ImageNet kullanmıştık. Aradaki fark çok önemli: ImageNet'te her fotoğrafın
sadece **etiketi** vardı. COCO'da ise her nesnenin etrafına **kutu çizilmiş**.
Model 'nerede' sorusunu bu yüzden cevaplayabiliyor."

"Ve COCO'daki nesneler stüdyoda değil, doğal ortamlarında — üst üste, kısmen kapalı,
farklı ışıkta. Gerçek hayata daha yakın."

**Söyle — ne yapılır:**
"Aynı aileden beş farklı görev var: tespit kutuyu verir, segmentasyon piksel
maskesini, poz iskelet noktalarını, sınıflandırma dünkü gibi tek etiketi, obb ise
eğik kutuyu. Model adının sonuna `-seg`, `-pose` eklemek yeterli."

"Biz bugün tespitle başlayıp üstüne takip ve sayma ekleyeceğiz."

**Söyle — boyutlar:**
"Dosya adının sonundaki harf model boyutu: n nano, s small, m medium, l large,
x xlarge. Büyüdükçe daha doğru ama daha yavaş. Biz `n` kullanacağız."

**Sorulursa — sürümler:**
"YOLO 2015'ten beri geliştiriliyor. v3 uzun süre standarttı, artık kullanılmıyor.
Güncel sürüm YOLO26. Kullanımı v8 ile neredeyse aynı olduğu için internetteki eski
öğreticiler hâlâ işinize yarar."

> Bu bölümü uzatma. Amaç YOLO'yu tanıtmak, tarihini anlatmak değil.
> 80 sınıf vurgusunu yap — 8. bölümde o listeye geri döneceğiz.
